...
export default function StoreHeroCarousel({
  ...
  return (
    <section className="overflow-hidden rounded-[28px] bg-gradient-to-br from-emerald-100 via-lime-50 to-white px-4 py-4 shadow-lg shadow-emerald-100 sm:rounded-[32px] sm:p-6 lg:p-8">
      <div className="grid gap-6 lg:grid-cols-[1.02fr_0.98fr] lg:items-center">
        <div>
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            ...
            <Link
              className="rounded-full border border-emerald-200 bg-white px-5 py-3 text-sm font-semibold text-emerald-800 transition hover:border-emerald-400 hover:bg-emerald-50"
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-3">
            {activeSlide.stats.map((stat) => (
              <article className="rounded-[22px] bg-white/90 px-4 py-4 shadow-sm backdrop-blur" key={stat.label}>
