...
export default function NotFound() {
  return (
    <main className="min-h-screen px-4 py-10 text-stone-900">
      <div className="mx-auto max-w-3xl rounded-lg border border-stone-200 bg-white p-8 shadow-sm">
        ...
        <Link
          className="mt-6 inline-block rounded-lg bg-amber-500 px-4 py-2 font-medium text-white hover:bg-amber-600"
